...
func TestBgpRoute_EvpnDisabledWithoutController(t *testing.T) {
	s := NewBgpRouteServer(nil, nil, nil, nil, nil, nil)
...
func TestBgpRoute_SrPolicyDisabledWithoutController(t *testing.T) {
	s := NewBgpRouteServer(&fakeAdvertiser{}, nil, nil, nil, nil, nil)
...
func TestBgpRoute_AdvertiseSrPolicy(t *testing.T) {
	fp := &fakeSRPolicyAdv{}
	s := NewBgpRouteServer(nil, fp, nil, nil, nil, nil)
...
func TestBgpRoute_AdvertiseVpn(t *testing.T) {
	fa := &fakeAdvertiser{}
	s := NewBgpRouteServer(fa, nil, nil, nil, nil, nil)
...
func TestBgpRoute_AdvertiseMup_T2ST(t *testing.T) {
	fm := &fakeMup{}
	s := NewBgpRouteServer(&fakeAdvertiser{}, nil, nil, fm, nil, nil)
