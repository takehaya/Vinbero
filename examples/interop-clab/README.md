...
| [`usid-l3vpn-2site`](scenarios/usid-l3vpn-2site/README.md) | FRR 10.2.1 | The 2-site L3VPN over uSID (NEXT-C-SID F3216, RFC 9800): both PEs use uSID locators, routes carry the RFC 9252 SID Structure, and Vinbero installs H.Encaps.Red — no SRH on the wire. |
