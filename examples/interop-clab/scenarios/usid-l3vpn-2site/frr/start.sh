...
# fd00:100:1::/48 route in frr.conf just fine, and a connected /48 is
...
# fd00:100:1::/48-on-eth2 route that beats its static toward pe-tokyo --
...
# The encapsulated return traffic follows the static fd00:100:1::/48 route
# from frr.conf via the core; no per-SID /128 override is needed.

# FRR auto-installs its End.DT4 localsid at the full micro-SID
# (fd00:200:2:1::). Vinbero folds the transposed VPN label back when it
