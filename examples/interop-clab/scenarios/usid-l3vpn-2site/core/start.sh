#!/bin/sh
# Provider backbone router for the usid-l3vpn-2site interop scenario.
#
...
ip -6 route replace fd00:100:1::/48    via 2001:db8:1::1 dev eth1
...
ip -6 route replace fd00:200:2::/48    via 2001:db8:2::1 dev eth2
