#!/bin/bash
# examples/end-dx6/setup.sh
# Setup End.DX6 demonstration environment
...
# Note: Linux interface names are limited to 15 chars, so use short prefix "dx6-"
...
# Configure IPv6 addresses for hosts (for End.DX6 demo)
print_info "Configuring IPv6 addresses for End.DX6 demo..."
...
# Configure SRv6-specific settings for End.DX6 demo
print_info "Configuring SRv6 End.DX6 settings..."
...
# Configure router3 (End.DX6 - Vinbero will handle this)
...
# Add Linux native End.DX6 for baseline testing (will be replaced by Vinbero)
...
echo "  End.DX6 at fc00:3::3 will be handled by Vinbero XDP"
echo ""
