...
# Linux interface names are limited to 15 chars, so use short prefix "ad-"
...
print_info "Configuring SRv6 End.AD settings..."
...
# End.AD; the baseline just proves the underlay path and resolves NDP).
...
echo ""
echo "=========================================="
echo "SRv6 End.AD Setup Complete!"
echo "=========================================="
echo "Forward: host1 -> [fc00:2::100 (End.AD via svc), fc00:3::3 (End.DX4)] -> host2"
