...
| EVPN (RT2/3/4)             | Supported | L2VPN over BGP EVPN: RT2 MAC/IP, RT3 Inclusive Multicast, RT4 Ethernet Segment with multi-homing (DF election / split-horizon). IRB (RT2 L3) and RT5 not yet supported | RFC 9252 |
